    ...
    Alpine.data('modal', () => ({
        ...
        addToTeam() {
            ...
            if (firstEmpty === -1) {
                window.dispatchEvent(new CustomEvent('team-toast', {
                    detail: {
                        message: `Team is full! <a href="/team" class="underline font-bold">Open Team Lab →</a> to make room.`,
                        type: 'error',
                    },
                }))
                return
            ...
            window.dispatchEvent(new CustomEvent('team-toast', {
                detail: {
                    message: `${name} added to your team! <a href="/team" class="underline font-bold">Open Team Lab →</a>`,
                    type: 'success',
                },
            }))
        },
