import type { BattleState, BattleAction, BattlePokemon } from './battle-engine'
import { calcDamageRange, getTypeEffectiveness } from './damage-calc'
import type { AttackerState, DefenderState, FieldState } from './damage-calc'
