...
export const EFFECTIVENESS: Record<string, number[]> = {
...
// Moves that were field HMs across Gen I–VII
export const HM_MOVES = new Set([
    'cut', 'fly', 'surf', 'strength', 'flash',
    'rock-smash', 'waterfall', 'dive', 'whirlpool', 'defog', 'rock-climb',
])
